...
<table width="150" valign="center" align="center"><strong><font size="4" color="blue"><br>修改图书</font></strong></table>
  <table cellSpacing=0 cellPadding=0 width=1024 align="center" bgColor=#ffffff border=0>
 <center>


<form method="GET" action="AlterBookServlet">
...
<p></p>
<center>
<button id="alterBook" type="submit" >修改</button>
<button id="alterBook" type="reset" >重置</button>
