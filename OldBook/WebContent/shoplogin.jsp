...
<div class="container-fluid">
  <div class="row" style="padding-top:12%">
    ...
    <div class="panel panel-info col-md-4" >
		...
		<form method="POST" action=ShopLoginServlet>
			<div class="input-group" style="width:100%;margin-bottom:20px;">
  				<span class="input-group-addon" style="width:20%;">用户名：</span>
  				<input style="width:100%;" type="text" class="form-control" name="loginName" id="loginName" placeholder="loginName" value="${requestScope.loginName}" aria-describedby="basic-addon1" required>
			</div>
			<div class="input-group" style="width:100%;margin-bottom:20px;">
  				<span class="input-group-addon" style="width:20%;">&nbsp;密&nbsp;码&nbsp;：</span>
  				<input style="width:100%;" type="password" class="form-control" name="loginPassword" id="loginPassword" placeholder="loginPassword" value="${requestScope.loginPassword }" aria-describedby="basic-addon1" required>
			</div>
			<div class="input-group" style="width:100%;margin-bottom:20px;">
  				...
  				<div class="input-group-addon" style="width:60%;float:left">
  					<img src="checkCode" alt="checkpicture" id="checkpicture" style="width:70%;float:left"/>
			...
			<span style="float:right" class="btn btn-link"><a href="shopregister.jsp" title="转到注册页面">立即注册</a></span>
		</form>
		</div>
	</div>
	<div class="col-md-1"></div>
