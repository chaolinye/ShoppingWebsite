...
<script>
	...
	function isUserExisted(){
		...
		$.ajax({
			type:"GET",
			url:"register?type=checkUserName&userName="+text,
			dataType:"text",
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" name="userName"
										id="userName" value="${requestScope.userName }" placeholder="如:lisi" required>
								</div>
								<div class="col-sm-2">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="password" class="form-control" name="password"
										id="password" value="${requestScope.password }" placeholder="" required>
								</div>
								<div class="col-sm-2">
								</div>
							</div>
